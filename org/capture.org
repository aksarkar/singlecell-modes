...
** Simple case
   ...
   have multiple descriptions of the data:

   \[ x_1 \sim \mathrm{Binomial}(Np, n_1 / N) \triangleq P_1 \]

   \[ x_1 \sim \mathrm{Hypergeometric}(Np, N, n_1) \triangleq P_2 \]

   \[ x_1 \sim \mathrm{Poisson}(n_1 p) \triangleq P_3 \]

   These have equal expected value \(n_1 p\), but unequal variances:

   \[ V_{P_1}[x_1] = n_1 p \frac{n_2}{N} \]

   \[ V_{P_2}[x_1] = n_1 p \frac{n_2}{N} \frac{N(1 - p)}{N - 1} \]
