...
*** Investigate genes with support for more complex models
    ...
    #+BEGIN_SRC ipython
      b_cells = read_10x('/project2/mstephens/aksarkar/projects/singlecell-ideas/data/10xgenomics/b_cells/filtered_matrices_mex/hg19/')
    #+END_SRC
    ...
    #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/b-cell-descend-examples.png
      ...
      for a, k in zip(ax.ravel(), query):
        a.hist(b_cells[:,k], bins=b_cells[:,k].max(), color='k')
      fig.tight_layout()
    #+END_SRC
