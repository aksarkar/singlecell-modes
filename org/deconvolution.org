...
*** Investigate ZINB vs. NB in high-depth data
   ...
   #+BEGIN_SRC ipython
     donor_info = pd.read_csv('http://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/working/20130606_sample_info/20130606_sample_info.txt', sep='\t')
   #+END_SRC
