...
** Heterogeneous cell populations
   ...
   #+BEGIN_SRC ipython :eval never
     data = {
       'pbmcs_68k': lambda: read_10x('/project2/mstephens/aksarkar/projects/singlecell-ideas/data/10xgenomics/fresh_68k_pbmc_donor_a/filtered_matrices_mex/hg19', return_df=True),
   ...
   #+BEGIN_SRC ipython :eval never
     ...
     task = tasks[int(os.environ['SLURM_ARRAY_TASK_ID'])]
     res = scmodes.benchmark.evaluate_deconv_generalization(data[task](), pool=None, test_size=0.1, random_state=0, methods=['nb', 'zinb'])
     res.index = x.columns
