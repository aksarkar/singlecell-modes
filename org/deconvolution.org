...
*** Run the benchmark
   ...
   #+NAME: read-ipsc
   #+BEGIN_SRC ipython :tangle /project2/mstephens/aksarkar/projects/singlecell-modes/code/benchmark.py
     def ipsc(prefix='/project2/mstephens/aksarkar/projects/singlecell-qtl/data', return_df=False, n=None, seed=0):
   ...
   Try to find a case in the full iPSC data where ZINB is required, by relying on the GPU
   implementation.
