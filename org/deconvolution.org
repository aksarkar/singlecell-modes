...
*** Naive/activated T cell mixture
    ...
    #+BEGIN_SRC ipython
      ...
      for data in ('cd8-cd19-mix', 'cyto-naive-t-mix'):
        benchmark[data] = (
          pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/deconv-generalization/{data}-gpu.txt.gz', sep='\t')
          .merge(pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/deconv-generalization/{data}-unimix.txt.gz', sep='\t'), on='0')
          .merge(pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/deconv-generalization/{data}-descend.txt.gz', sep='\t'), on='0')
          .merge(pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/deconv-generalization/{data}-npmle.txt.gz', sep='\t'), on='0')
          .merge(pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/deconv-generalization/{data}-saturated.txt.gz', sep='\t'), on='0')
          .set_index('0'))
    #+END_SRC
