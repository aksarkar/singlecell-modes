...
*** Run the benchmark
    ...
    #+BEGIN_SRC sh :noweb eval :dir /scratch/midway2/aksarkar/modes/
      sbatch -a 0 --partition=broadwl -n1 -c28 --exclusive --time=60:00 --mem=4G --job-name=deconv-generalization --out=benchmark-cpu.out
      #!/bin/bash
      source activate scmodes
      python <<EOF
