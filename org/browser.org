...
* Test environment
  ...
  : bokeh serve capture gof markers --address $(hostname -i)  --allow-websocket-origin=$(hostname -i):5006 &
  : [20] 38545
...
* Production environment
  ...
  Welcome to Ubuntu 18.04.1 LTS (GNU/Linux 4.15.0-65-generic x86_64)
   ...
   ,* Support:        https://ubuntu.com/advantage
    ...
    System information as of Fri Dec 13 23:50:23 CST 2019
  ...
  Last login: Thu Nov 21 20:59:25 2019 from 128.135.112.68
  #+end_example
  ...
  Last login: Fri Nov 22 03:01:02 2019 from 10.0.2.2
  #+end_example
  ...
  #+RESULTS:
  : 
  : (scmodes) vagrant@stretch:/vagrant$ [1] 661
