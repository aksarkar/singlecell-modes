...
* Production environment
  ...
  Welcome to Ubuntu 18.04.1 LTS (GNU/Linux 4.15.0-43-generic x86_64)
   ...
   ,* Support:        https://ubuntu.com/advantage
    ...
    System information as of Mon Jul 22 11:16:52 CDT 2019
  ...
  Last login: Wed Jun  5 23:42:47 2019 from 128.135.112.68
  #+end_example
  ...
  Last login: Mon Jul 22 16:29:13 2019 from 10.0.2.2
  #+end_example
  ...
  #+BEGIN_SRC sh :session shiny
    cd /vagrant
    source activate scmodes
    nohup bokeh serve capture --port 5006 --allow-websocket-origin=shiny.stephenslab.uchicago.edu:5009 &
  #+END_SRC

  #+RESULTS:
  : 
  : (scmodes) vagrant@stretch:/vagrant$ [1] 651
