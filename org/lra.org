...
** Plot the results
   ...
   #+BEGIN_SRC ipython
     cortex = pd.concat([
       pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/lra-generalization/cortex-glmpca.txt.gz', sep='\t', index_col=0),
       pd.read_csv('/project2/mstephens/aksarkar/projects/singlecell-modes/data/lra-generalization/cortex-nmf.txt.gz', sep='\t', index_col=0)
     ], axis='columns')
   #+END_SRC
