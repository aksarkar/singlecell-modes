...
* Setup
  ...
  #+CALL: ipython3(memory="32G",partition="mstephens",venv="scmodes") :dir /scratch/midway2/aksarkar/modes :exports none

  #+RESULTS:
  : Submitted batch job 62153033
...
** Homogeneous populations
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/b-cell-npmle-examples.png
     plt.clf()
   ...
   :RESULTS:
   # Out[37]:
   [[file:figure/deconvolution.org/b-cell-npmle-examples.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/cytotoxic-t-npmle-examples.png
     plt.clf()
     fig, ax = plt.subplots(4, 3)
     fig.set_size_inches(7, 5)
     for a, k in zip(ax.ravel(), query):
   ...
   :RESULTS:
   # Out[39]:
   [[file:figure/deconvolution.org/cytotoxic-t-npmle-examples.png]]
   :END:

   Make sure our choice of discretization for unimodal is acceptable on
   /RPL34/.

   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/cytotoxic-t-rpl34.png
     k = 'ENSG00000109475'
     x = cytotoxic_t.loc[:,k]
   ...
   :RESULTS:
   # Out[41]:
   [[file:figure/deconvolution.org/cytotoxic-t-rpl34.png]]
   :END:

   Mengyin Lu previously reported /CCL5/ could possibly have bimodal
   expression. Look at the fitted distributions for /CCL5/.

   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/cytotoxic-t-ccl5.png
     k = 'ENSG00000161570'
     x = cytotoxic_t.loc[:,k]
     s = cytotoxic_t.sum(axis=1)
   ...
   :RESULTS:
   # Out[93]:
   [[file:figure/deconvolution.org/cytotoxic-t-ccl5.png]]
   :END:
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/ipsc-slc25a5.png
     k = 'ENSG00000005022'
     x = ipsc_counts.loc[:,k]
   ...
   :RESULTS:
   # Out[49]:
   [[file:figure/deconvolution.org/ipsc-slc25a5.png]]
   :END:
...
*** Investigate Gamma vs. Point-Gamma in high-depth data
    ...
    The two genes are /PACRG/ and /RPS4Y1/. Look at the fitted distributions
    for these genes.
    ...
    #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/ipsc-pacrg.png
      k = 'ENSG00000112530'
    ...
    :RESULTS:
    # Out[91]:
    [[file:figure/deconvolution.org/ipsc-pacrg.png]]
    :END:
    ...
    #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/ipsc-rps4y1.png
      k = 'ENSG00000129824'
      x = ipsc_counts.loc[:,k].values
    ...
    :RESULTS:
    # Out[92]:
    [[file:figure/deconvolution.org/ipsc-rps4y1.png]]
    :END:
...
** Synthetic mixtures
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconv-examples.org/cd8-cd19-mlcb-examples.png
     llik_diff = benchmark['cd8-cd19-mix']['npmle'] - benchmark['cd8-cd19-mix']['unimodal']
   ...
   :RESULTS:
   # Out[13]:
   [[file:figure/deconv-examples.org/cd8-cd19-mlcb-examples.png]]
   :END:
...
** Cortex
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconvolution.org/cortex-ttr.png
     k = 'Ttr'
   ...
   :RESULTS:
   # Out[60]:
   [[file:figure/deconvolution.org/cortex-ttr.png]]
   :END:
...
** PBMCs
   ...
   #+BEGIN_SRC ipython :ipyfile figure/deconv-examples.org/pbmc-npmle-examples.png
   ...
   :RESULTS:
   # Out[63]:
   [[file:figure/deconv-examples.org/pbmc-npmle-examples.png]]
   :END:
