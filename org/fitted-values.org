...
** B cells
   ...
   #+BEGIN_SRC sh :noweb eval :dir /scratch/midway2/aksarkar/modes/
     ...
     train_t = xt[:900]
     test_t = xt[900:]
     m = scmodes.lra.PVAE(input_dim=train.shape[1], latent_dim=10).fit(train_t, y=test_t, lr=1e-3, max_epochs=200, trace=True)
