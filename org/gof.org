...
** Application to biological data sets
    ...
    *Remark* We previously fit point-Gamma distributions to the iPSC data
    ...
    100, 1000)\), for genes which departed from a unimodal assumption on
...
** Browser
   ...
   Populate the database with the genes departing from a unimodal expression
   model.
