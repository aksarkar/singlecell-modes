...
* Figure 2
  ...
  :END:
   ...
   #+BEGIN_SRC ipython
     ...
     lam0 = np.load('/scratch/midway2/aksarkar/modes/fitted-values/pbmcs_68k-nmf-lam.npy')
     lam1 = np.load('/scratch/midway2/aksarkar/modes/fitted-values/pbmcs_68k-glmpca-lam.npy')
     lam2 = np.load('/scratch/midway2/aksarkar/modes/fitted-values/pbmcs_68k-pvae-lam.npy')
