...
* Figure 2
  ...
  :END:
   ...
   #+BEGIN_SRC ipython
     ...
     data = ['b_cells', 'cytotoxic_t', 'ipsc', 'cytotoxic_t-b_cells', 'cytotoxic_t-naive_t', 'pbmcs_68k']
     titles = ['T cell', 'B cell', 'iPSC', 'T cell/B cell', 'Cytotoxic/naive T', 'PBMC']
   #+END_SRC
   ...
   #+BEGIN_SRC ipython :ipyfile figure/figures.org/pois-loss-improvement-8.svg
     plt.clf()
     fig, ax = plt.subplots(1, 6, sharey=True)
     fig.set_size_inches(8, 2.5)
   ...
   :RESULTS:
   # Out[8]:
   [[file:figure/figures.org/pois-loss-improvement-8.svg]]
   :END:
