...
* Shalek et al. 2014
  ...
  [[https://www.nature.com/articles/nature13437#s1][Shalek et al. 2014]]
  performed scRNA-seq of >
  [[https://www.nature.com/articles/nature13437#s1][1700 cells]], and
  ...
  them, assuming no noise. However, more ideally, we should use the read model
  to define the likelihood, and then deconvolve the reads under a
  distributional assumption on the latent gene expression values.
