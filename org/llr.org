...
** Estimate marginal log likelihood
   ...
   #+NAME: shard
   #+BEGIN_SRC sh :noweb eval :dir /scratch/midway2/aksarkar/modes/
     sbatch --partition=broadwl -n1 -c28 --exclusive --job-name=llik --time=24:00:00 -a 201-213,216,230
     #!/bin/bash
     source activate scmodes
     python <<EOF
     <<imports>>
...
** Application to control data sets
   ...
   #+BEGIN_EXAMPLE
     ...
     0       -263.565367  -261.759913
     1       -347.518213  -337.364384
     2      -5944.693604 -5944.555342
   #+END_EXAMPLE
   :END:
...
** Application to biological data sets
   ...
   #+BEGIN_EXAMPLE
     ...
     pbmcs_68k            0.000923     0.200246  0.685020  0.450784
   ...
   #+BEGIN_EXAMPLE
     ...
     cytotoxic_t-naive_t  0.042747  0.043228     0.043388  0.043868
     ...
     pbmcs_68k            0.000000  0.000000     0.000308  0.002615
     retina               0.000000  0.000000     0.001095  0.011944
   #+END_EXAMPLE
   :END:
