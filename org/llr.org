...
** Application to control data sets
   ...
   Of those genes, report the number of genes for which the likelihood ratio in
   favor of the unimodal model is not greater than one.
...
** Application to biological data sets
   ...
   Report the fraction of genes with strong evidence over a point mass
   expression model.
   ...
   The liver data shows little expression variation because the relative gene
   expression is low for almost all genes.
   ...
   Report the fraction of genes with strong evidence over a Gamma expression
   model.
   ...
   Report the fraction of genes with suggestive evidence over a Gamma expression
   model.
   ...
   Report the fraction of genes with strong evidence over a unimodal expression
   model.
...
*** Unimodal vs. Gamma
    ...
    #+BEGIN_SRC ipython
      query = (temp
               .iloc[np.argsort(-temp['unimodal'] + temp['gamma'])]
               .reset_index())
      query = query[query['unimodal'] >= query['npmle']].head(n=10)
      query
    #+END_SRC
    ...
    # Out[63]:
    #+BEGIN_EXAMPLE
      method      level_0             gene         gamma         npmle  \
      ...
      method          point   point_gamma      unimodal
      56     -210393.391504  -5298.738618  -4178.292122
      147     -74261.620889  -6048.895471  -5388.534550
      170     -10483.945396  -6213.424629  -5615.144543
      174      -4577.708340  -3076.552292  -3052.640395
      188      -7338.824690  -6772.110462  -6216.912371
      202     -73444.511669  -2534.657909  -2005.458099
      220     -26614.977976 -16484.165961 -16435.610729
      230      -2025.719067  -1255.871231  -1253.016660
      338     -23388.860965  -8496.428406  -8427.946446
      370    -305710.877575  -8541.033149  -8244.471002
    #+END_EXAMPLE
    :END:

    #+BEGIN_SRC ipython :async t :ipyfile figure/llr.org/unimodal-gamma-ex.png
    ...
    :RESULTS:
    # Out[40]:
    [[file:figure/llr.org/unimodal-gamma-ex.png]]
    :END:
    ...
    #+BEGIN_SRC ipython :ipyfile figure/llr.org/pbmc_10k_v3-ex.png
      cm = plt.get_cmap('Dark2')
      plt.clf()
      ...
      for i, k in enumerate(pmf):
        ax[1].plot(y + 0.5, x.shape[0] * pmf[k], lw=1, c=cm(i), label=k)
        ax[2].plot(grid, cdf[k], lw=1, c=cm(i), label=k)
      ax[0].set_xlabel('Number of molecules')
    ...
    :RESULTS:
    # Out[95]:
    [[file:figure/llr.org/pbmc_10k_v3-ex.png]]
    :END:
...
*** Non-parametric vs. Gamma
    ...
    #+BEGIN_EXAMPLE
      name      unimodal         npmle
      2473     NUP98 -15972.366357 -15756.178286
      2643     PACRG -20162.088196 -19946.833473
      3911    RPS4Y1 -18020.981045 -17869.536003
      9784     RDH14  -6907.997280  -6848.767769
      2029     RPS19 -28704.469940 -28662.273715
      9386    MT-ND4 -35817.034361 -35781.158161
      9392   MT-ATP6 -35036.853122 -35004.943643
      540       VMP1 -27442.499556 -27419.742185
      9333    MT-CO2 -32850.155131 -32827.614183
      9777      ADSL -16389.557095 -16368.599617
      9410    MT-CO3 -33337.091142 -33316.609451
      9339    MT-CYB -34450.722833 -34432.385082
      9388    MT-ND1 -29886.918324 -29871.024645
      9348    MT-ND2 -31773.353979 -31757.691218
      9879     EEF1G -19854.291184 -19839.299095
      8139      RHOG  -8384.631765  -8370.034146
      9351    MT-ND5 -28018.138347 -28004.922013
      9118  HIST1H4C -30027.808944 -30014.993547
      9358    MT-CO1 -30590.814531 -30578.200751
      8503    RPS17L -16131.042331 -16119.353411
    #+END_EXAMPLE
    :END:
    ...
    #+BEGIN_EXAMPLE
      name      unimodal        npmle
      2717  SKP1 -22075.223767 -22074.08724
    #+END_EXAMPLE
    :END:
